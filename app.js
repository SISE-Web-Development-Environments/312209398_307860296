...
function drawRightPacman(center) {
	context.beginPath();
	context.arc(center.i* 60 + 30, center.j* 60 + 30, 30, 0.15 * Math.PI, 1.85 * Math.PI); // half circle
	context.lineTo(center.i*60+30, center.j*60+30);
	context.fillStyle = pac_color; //color
	context.fill();
	context.beginPath(); //pacman eye
	context.arc(center.i* 60 + 30 + 5, center.j* 60 + 30 - 15, 5, 0, 2 * Math.PI); // circle
...
function drawLeftPacman(center) {
	context.beginPath();
	context.arc(center.i* 60 + 30, center.j* 60 + 30, 30, 1.15 * Math.PI, 0.85 * Math.PI); // half circle
	context.lineTo(center.i*60+30, center.j*60+30);
	context.fillStyle = pac_color; //color
	context.fill();
	context.beginPath(); //pacman eye
...
function drawUpPacman(center) {
	context.beginPath();
	context.arc(center.i* 60 + 30, center.j* 60 + 30, 30, 1.65 * Math.PI, 1.35 * Math.PI); // half circle
	context.lineTo(center.i*60+30, center.j*60+30);
	context.fillStyle = pac_color; //color
	context.fill();
	context.beginPath(); //pacman eye
...
function drawDownPacman(center) {
	context.beginPath();
	context.arc(center.i* 60 + 30, center.j* 60 + 30, 30, 0.65 * Math.PI, 0.35 * Math.PI); // half circle
	context.lineTo(center.i*60+30, center.j*60+30);
	context.fillStyle = pac_color; //color
	context.fill();
	context.beginPath(); //pacman eye
